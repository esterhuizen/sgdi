...
// Temporary exclusion list lives in @/lib/impact-exclusion so /impact's
// page and OG image stay in sync. See that file for the rationale and
// removal trigger. After the canonical promotion the exclusion applies
// to all builds, not just shadow — the GDI step-changes are the same
// regardless of which env serves them.
...
export default async function ImpactPage() {
  ...
  // Also drops the temporarily-excluded pools — see @/lib/impact-exclusion.
